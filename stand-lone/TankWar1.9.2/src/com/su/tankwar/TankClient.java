...
/**
 * 增加多个 enemies and can be killed
 * let all the enemy tanks move randomly
 * use random generator to decide the direction
 * add an attribute (direction) to Tank as the initial direction
 * change the direction randomly after each move
 * let all enemy tanks change their directions after moving random steps 
 * @author su
 *
 */
public class TankClient extends Frame{
	...
	Tank myTank = new Tank(80, 80, true, Direction.STOP, this); // instantiate a tank ++++++++
	...
	private void launchFrame(){
		// add enemies 
		for (int i = 0; i < 10; ++i){
			Tank  tank = new Tank(50 * (i +3), 50, false, Direction.D, this );
			enemyTanks.add(tank);
		}
