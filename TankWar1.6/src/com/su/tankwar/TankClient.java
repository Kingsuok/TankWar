...
/**
 *处理 missile hit the tank， tank 和missile 消失
 *用到rectangle，
 *子弹打到 tank ，所以在子弹中添加 hitTank 方法，然后返回值 boolean， tank 中添加 live属性，
 * 
 * @author su
 *
 */
public class TankClient extends Frame{
	...
	Tank myTank = new Tank(50, 50, true, this); // instantiate a tank ++++++++
