...
/**
 *
 * add configure to set the parameters
 * @author su
 *
 */
public class TankClient extends Frame{
	...
	// build a wall
	private Wall wall1 = new Wall(250,190 ,20 , 160, this);
	private Wall wall2 = new Wall(300,400 ,20 , 160, this);
	...
	public void paint(Graphics g) {
		...
		if (enemyTanks.size()< 6){
			for (int i = 0; i < random.nextInt(3) ; ++i){
				Tank  tank = new Tank(100, 40 * (random.nextInt(6)+2) ,  false, Direction.D, this );
				Tank  tank1 = new Tank(600, 40 * (random.nextInt(6)+2) ,  false, Direction.D, this );
				enemyTanks.add(tank);
	...
	private void launchFrame(){
		...
		// get the properties from the configure file
		...
		int tankCount = Integer.parseInt(properties.getProperty("tankCount"));
