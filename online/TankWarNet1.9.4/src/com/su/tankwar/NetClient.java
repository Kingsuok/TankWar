...
public class NetClient {
	...
	public void send(TankNewMessage tankNewMessage){
		
		tankNewMessage.send(datagramSocket,serverIP, serverUDP_PORT);
	}
	...
	private class UDPReceiveThread implements Runnable{
		...
		private void parse(DatagramPacket datagramPacket) {
			...
			TankNewMessage tankNewMessage = new TankNewMessage();
			tankNewMessage.parse(dataInputStream);
		}
